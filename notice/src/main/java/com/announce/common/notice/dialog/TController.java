 ...
 * @time 2018/5/12
 **/
public class TController<A extends SGBaseAdapter> implements Parcelable, Serializable {
    ...
    private A adapter;
    private SGBaseAdapter.OnAdapterItemClickListener adapterItemClickListener;
    ...
    public SGBaseAdapter.OnAdapterItemClickListener getAdapterItemClickListener() {
        return adapterItemClickListener;
    }

    public void setAdapterItemClickListener(SGBaseAdapter.OnAdapterItemClickListener adapterItemClickListener) {
    ...
    /**************************************************************************
     */
    public static class TParams<A extends SGBaseAdapter> {
        ...
        //列表
        public A adapter;
        public SGBaseAdapter.OnAdapterItemClickListener adapterItemClickListener;
